...
################################################################################
#./runDCE-CoAP.sh 10 10 10 115.4 512 udp 0 5 10.1.0.1 0 true true /media/samettonyali/5a1a8839-e023-40e3-9acf-839568bc2148/samet/Desktop/1024Nodes/coap-standard-jitterOn-mixedOn
row=$1
column=$2
firstSTime=$3
totalTime=$4
